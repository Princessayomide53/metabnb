  ...
  return (
    <div className="overflow-hidden">
      <div className=" grid-cols-1">
        <div className=" bg-black grid lg:grid-cols-4 gap-8 place-items-center lg:space-x-28 md:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-4 xl:space-x-28 2xl:space-x-28">
          ...
          <div className="w-32 lg:h-72 h-44 text-white lg:pt-16 pt-5 md:pt-5">
