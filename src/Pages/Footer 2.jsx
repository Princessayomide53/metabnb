    ...
    <div className="overflow-hidden">
      <div className=" grid-cols-1">
        <div className=" bg-black grid lg:grid-cols-4 gap-8 lg:space-x-28 md:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-4 xl:space-x-28 2xl:space-x-28">
          <div className="w-56 lg:h-72 h-48 pl-10 xl:pl-5 2xl:pl-5 md:pl-10">
          ...
          <div className="w-32 lg:h-72 h-44 text-white lg:pt-16 pl-10 lg:pl-0 xl:pl-0 2xl:pl-0 md:pt-0 pt-0">
          ...
          <div className="w-32 lg:h-72 h-44 text-white pl-10 lg:pl-0 xl:pl-0 2xl:pl-0 lg:pt-16 md:pt-0 pt-0">
